...
| BAUDRATE       |          | Serial port baudrate (depends on firmware), defaults to 460800                 | 460800            |
| BACKBONE_IF    |    x     | Underlying network interface to use                                            | wlan0             |
| FLOW_CONTROL   |          | If hardware flow control should be enabled (depends on firmware), defaults to 1 | 0                 |
